        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
                  ...
                  msg = (function() {
                    switch (code) {
                      ...
                      case vc.HASH_MISMATCH:
                        return "file contents do not match (expected " + expected.hash.hash.slice(0, 8) + "... but got " + got.hash.hash.slice(0, 8) + "...)";
              ...
              if (err_count) {
                return log.error("Exited after " + err_count + " error(s).");
              } else {
                if (!_this.args.quiet) {
                  return log.info("Success! " + json_obj.found.length + " items checked" + (warn_count ? ' with ' + warn_count + ' warning(s); pass --strict to prevent success on warnings' : ''));
                }
              }
            });
          });
