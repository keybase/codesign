            ...
            (function(__iced_k) {
              ...
              if (warn_table.length) {
                for (_i = 0, _len = warn_table.length; _i < _len; _i++) {
                  p = warn_table[_i];
                  log.warn("" + p[0] + "\t" + (((_ref1 = p[1].expected) != null ? _ref1.fname : void 0) || p[1].got.fname) + "\t" + p[1].msg);
                }
              }
              if (err_table.length) {
                for (_j = 0, _len1 = err_table.length; _j < _len1; _j++) {
                  p = err_table[_j];
                  log.error("" + p[0] + "\t" + (((_ref2 = p[1].expected) != null ? _ref2.fname : void 0) || p[1].got.fname) + "\t" + p[1].msg);
                }
