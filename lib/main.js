...
(function() {
  var ArgumentParser, Main, PackageJson, Summarizer, constants, from_md, fs, iced, item_type_names, path, tablify, to_md, __iced_k, __iced_k_noop, _ref,
  ...
  Main = (function() {
    ...
    Main.prototype.verify = function() {
      var body, err, expected, f, got, input, json_obj, summ, table, warn, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            var _i, _j, _k, _len, _len1, _len2, _ref1, _ref2, _ref3, _ref4, _ref5;
            if (typeof err !== "undefined" && err !== null) {
              _this.exit_err(err);
            }
            _ref1 = summ.compare_to_json_obj(json_obj), err = _ref1.err, warn = _ref1.warn;
            if (err != null) {
              console.log("ERRORS\n---------------");
              table = [];
              _ref2 = err.missing;
              ...
              for (_k = 0, _len2 = _ref4.length; _k < _len2; _k++) {
                _ref5 = _ref4[_k], got = _ref5.got, expected = _ref5.expected;
                if (got.item_type !== expected.item_type) {
                  ...
                  table.push([got.path, "Bad contents (expected sha256 hash " + expected.hash.hash.slice(0, 8) + "...; got " + got.hash.hash.slice(0, 8) + "...)"]);
            ...
            if (err == null) {
              return console.log("Success! " + (warn != null ? ' (with warnings)' : ''));
            }
          });
        };
      })(this));
