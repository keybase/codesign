...
(function() {
  var ArgumentParser, Main, PackageJson, CodeSign, constants, from_md, fs, iced, item_type_names, log, path, tablify, to_md, utils, vc, __iced_k, __iced_k_noop, _ref,
  ...
  Main = (function() {
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            CodeSign.from_dir(_this.args.dir, {
              ignore: ignore,
    ...
    Main.prototype.verify = function() {
      var body, code, err, err_table, expected, fname, got, input, json_obj, label, msg, probs, r, summ, warn_table, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      input = this.args.input || constants.defaults.FILENAME;
      (function(_this) {
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              var _i, _j, _k, _len, _len1, _len2, _ref1, _ref2;
              err_table = [];
              warn_table = [];
              ...
              if (warn_table.length && !_this.args.quiet) {
                for (_j = 0, _len1 = warn_table.length; _j < _len1; _j++) {
                  r = warn_table[_j];
                  log.warn("" + r[0] + "\t" + r[1]);
                }
              }
              if (err_table.length) {
                for (_k = 0, _len2 = err_table.length; _k < _len2; _k++) {
                  r = err_table[_k];
                  log.error("" + r[0] + "\t" + r[1]);
                }
