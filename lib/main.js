          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              if (err_table.length) {
                ...
                if (!_this.args.quiet) {
                  return log.info("Success! " + json_obj.found.length + " items checked" + (warn_table.length ? ' with ' + warn_table.length + ' warning(s); pass --strict to prevent success on warnings' : ''));
                }
              }
            });
          });
