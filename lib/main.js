...
(function() {
  ...
  Main = (function() {
    ...
    Main.prototype.verify = function() {
      var body, err, input, json_obj, summ, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            if (err) {
              return console.log("DOES NOT MATCH", err);
            } else {
              return console.log("They match!");
            }
          });
        };
      })(this));
