...
(function() {
  var DropboxPreset, GitPreset, GlobberPreset, PackageJson, SummarizedItem, Summarizer, XPlatformHash, constants, finfo_cache, iced, item_types, make_esc, path, tablify, utils, __iced_k, __iced_k_noop,
  ...
  SummarizedItem = (function() {
    ...
    SummarizedItem.prototype.load_traverse = function(cb) {
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            if (_this.finfo.lstat.isSymbolicLink()) {
              ...
              (function(__iced_k) {
                ...
                _this.finfo.readlink(esc(__iced_deferrals.defer({
                  assign_fn: (function(__slot_1) {
                    return function() {
              ...
              (function(__iced_k) {
                if (_this.finfo.stat.isFile()) {
                  ...
                  (function(__iced_k) {
                    ...
                    _this.finfo.hash('sha256', 'hex', esc(__iced_deferrals.defer({
                      assign_fn: (function(__slot_1) {
                        return function() {
                    ...
                    _this.finfo.is_binary(esc(__iced_deferrals.defer({
                      assign_fn: (function(__slot_1) {
                        return function() {
                          return __slot_1.binary = arguments[0];
                        };
                      })(_this),
                      lineno: 45
                    })));
                          ...
                          (function(__iced_k) {
                            ...
                            (function(__iced_k) {
                              if (!ignore) {
                                ...
                                return __iced_k(console.log("Ignoring " + subpath + "..."));
                              }
                            })(_next);
                          });
                        }
...
_break()
    ...
    Summarizer.prototype.compare_to_json_obj = function(obj) {
       ...
       */
      var err, f, k, o1_by_path, o2_by_path, ok, v, v2, warn, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
      err = {
        missing: [],
        wrong: [],
        orphans: []
      ...
      for (k in o2_by_path) {
        ...
        if ((v2 = o1_by_path[k]) == null) {
          ...
          if (ok && !this.hash_alt_match(v.hash, v2.hash)) {
            err.wrong.push({
              expected: v,
              got: v2
            });
            ...
            if (!this.hash_match(v.hash, v2.hash)) {
              warn.alt_hash_matches.push({
                expected: v,
                got: v2
              });
            }
      ...
      if (!(warn.missing_dirs.length || warn.orphan_dirs.length || warn.alt_hash_matches.length)) {
        warn = null;
      }
      return {
        err: err,
