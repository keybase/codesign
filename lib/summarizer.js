...
(function() {
  var DropboxPreset, GitPreset, PackageJson, SummarizedItem, Summarizer, constants, crypto, fs, iced, item_types, make_esc, path, tablify, utils, __iced_k, __iced_k_noop,
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        switch (p) {
          case 'git':
            ...
            break;
          case 'dropbox':
            _results.push(this.presets.push(new DropboxPreset()));
            break;
          case 'none':
            continue;
          default:
