...
(function() {
  ...
  SummarizedItem = (function() {
    function SummarizedItem(_arg) {
      var fname, parent_path;
      parent_path = _arg.parent_path, fname = _arg.fname;
    ...
    SummarizedItem.prototype.load_traverse = function(cb) {
      ...
      p = path.join(this.parent_path, this.fname);
      (function(_this) {
                      ...
                      (function(__iced_k) {
                        ...
                        _while = function(__iced_k) {
                          ...
                          if (!(_i < _len)) {
                            ...
                            f = _ref1[_i];
                            si = new SummarizedItem({
                              fname: f,
                              parent_path: path.join(_this.parent_path, _this.fname)
                            });
                            (function(__iced_k) {
                              __iced_deferrals = new iced.Deferrals(__iced_k, {
                                parent: ___iced_passed_deferral,
    ...
    SummarizedItem.prototype.to_str = function(depth) {
      ...
      switch (this.item_type) {
        case item_types.FILE:
          return "\n" + indent + this.fname + "      " + this.hash;
        case item_types.SYMLINK:
          return "\n" + indent + this.fname + "   -> " + this.link;
        case item_types.DIR:
          Summarizer.sort_items(this.contents);
          return ("\n" + indent + this.fname + "/") + ((function() {
  ...
  Summarizer = (function() {
    ...
    Summarizer.from_dir = function(dir, cb) {
      var err, root_item, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        ...
        return function() {
          if (err) {
            ...
            return cb(null, new Summarizer(root_item));
          }
        };
      })(this));
    };
