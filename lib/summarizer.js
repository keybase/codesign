...
(function() {
  var DropboxPreset, GitPreset, GlobberPreset, PackageJson, SummarizedItem, Summarizer, XPlatformHash, constants, fs, iced, item_types, make_esc, path, tablify, utils, __iced_k, __iced_k_noop,
  ...
  SummarizedItem = (function() {
    ...
    SummarizedItem.prototype.signable_info = function() {
      ...
      info = {
        ...
        exec: utils.is_user_executable(this.stats)
      };
    ...
    SummarizedItem.prototype.hash_contents = function(cb) {
      var err, fd, h, hash_res, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      h = new XPlatformHash({
        alg: 'sha256',
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/chris/git/keybase/dir-summarize/src/summarizer.iced",
            funcname: "SummarizedItem.hash_contents"
          });
          h.hash(fd, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
                return hash_res = arguments[1];
              };
            })(),
            lineno: 107
          }));
...
_break()
    ...
    Summarizer.prototype.hash_match = function(h1, h2) {
      return (!((h1 != null) || (h2 != null))) || (h1.hash === h2.hash);
    };

    Summarizer.prototype.hash_alt_match = function(h1, h2) {
      return (!((h1 != null) || (h2 != null))) || (h1.hash === h2.hash) || (h1.alt_hash === h2.hash) || (h1.hash === h2.alt_hash);
    };
    ...
    Summarizer.prototype.compare_to_json_obj = function(obj) {
       ...
       */
      var err, f, k, o1_by_path, o2_by_path, ok, v, v2, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
      err = {
        missing: [],
        wrong: [],
        orphans: [],
      ...
      for (k in o2_by_path) {
        ...
        if ((v2 = o1_by_path[k]) == null) {
          ...
          for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
            k = _ref2[_k];
            if ((v[k] !== v2[k]) || !this.hash_alt_match(v.hash, v2.hash)) {
              ok = false;
              err.wrong.push({
                expected: v,
                got: v2
      ...
      if (err.missing.length || err.wrong.length || err.orphans.length || err.hash_warns.length) {
        return err;
      } else {
        return null;
      }
