  ...
  FileInfo = (function() {
    ...
    FileInfo.prototype._x_platform_type_check = function(cb) {
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            if ((_this.item_type === item_types.FILE) && (_this.stat.size < 1024) && (!_this._is_binary)) {
              (function(__iced_k) {
                __iced_deferrals = new iced.Deferrals(__iced_k, {
                  parent: ___iced_passed_deferral,
                  filename: "/Users/chris/git/keybase/dir-summarize/src/file_info_cache.iced",
                ...
                lines = data.split(/[\n\r]+/g);
                return __iced_k(lines.length === 1 ? (_this.possible_win_link = lines[0], console.log("Found possible windows link '" + _this.full_path + "' -> '" + _this.possible_win_link + "'")) : void 0);
              });
            } else {
              return __iced_k();
            }
