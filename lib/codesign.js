...
(function() {
  var DropboxPreset, GitPreset, GlobberPreset, KbPreset, PackageJson, SummarizedItem, CodeSign, constants, iced, item_types, path, vc, __iced_k, __iced_k_noop,
  ...
  CodeSign = (function() {
    ...
    CodeSign.prototype.should_ignore = function(path_to_file, cb) {
                ...
                if (!(_i < _len)) {
                  ...
                  (function(__iced_k) {
                    __iced_deferrals = new iced.Deferrals(__iced_k, {
                      ...
                      funcname: "CodeSign.should_ignore"
                    });
...
_break()
    ...
    CodeSign.prototype.set_root_item = function(ri) {
      return this.root_item = ri;
    };

    CodeSign.prototype.root_dir = function() {
      return this.opts.root_dir;
    };

    CodeSign.from_dir = function(dir, opts, cb) {
    ...
    CodeSign.prototype.hash_match = function(h1, h2) {
      return (!((h1 != null) || (h2 != null))) || ((h1 != null ? h1.hash : void 0) === (h2 != null ? h2.hash : void 0));
    };

    CodeSign.prototype.hash_alt_match = function(h1, h2) {
