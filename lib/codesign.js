...
(function() {
  var CodeSign, DropboxPreset, GitPreset, GlobberPreset, KbPreset, PackageJson, SummarizedItem, constants, iced, item_types, make_esc, path, vc, __iced_k, __iced_k_noop,
...
_break()
    ...
    CodeSign.prototype.compare_to_json_obj = function(obj, cb) {
      ...
      for (p1 in exp_by_path) {
        ...
        } else if ((expected.item_type === item_types.FILE) && (got.item_type === item_types.SYMLINK) && this._hash_alt_match(expected.hash, got.link_hash)) {
          status = vc.ALT_SYMLINK_MATCH;
