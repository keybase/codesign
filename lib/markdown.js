...
(function() {
  var HEADINGS, SPACER, constants, files_from_pretty_format, hash_from_str, hash_to_str, item_types, max_depth, path, pretty_format_files, tablify, utils;
  ...
  pretty_format_files = function(found_files) {
    var col0, col1, col2, col3, f, i, rows, _i, _len;
    rows = [HEADINGS];
    for (_i = 0, _len = found_files.length; _i < _len; _i++) {
      f = found_files[_i];
      col0 = f.item_type === item_types.FILE ? f.size : '';
      col1 = f.exec ? 'x' : '';
      col2 = ((function() {
      ...
      col3 = (function() {
        switch (f.item_type) {
          ...
          case item_types.FILE:
            if (f.hash.hash === f.hash.alt_hash) {
              return f.hash.hash;
            } else {
  ...
  files_from_pretty_format = function(str_arr) {
    var a0, a1, a2, a3, b0, b1, b2, b3, c0, c1, c2, c3, fparts, fpath, info, r0, res, s, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4;
    res = [];
    r0 = str_arr[0];
