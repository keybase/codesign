...
(function() {
  var files_from_pretty_format, item_types, max_depth, path, pretty_format_files, tablify, utils;
  ...
  exports.to_md = function(o) {
    var file_list, ignore_list, res, s;
  ...
  exports.from_md = function(str) {
    var f, file_rows, ignore_rows, match, rxx, version;
    rxx = /^\s*\#\#\#\#\sVerify\s*```([^`]*)```\s*\#\#\#\#\sIgnore\s*```([^`]*)```\s*\<\!--[\s]*summarize[\s]*version[\s]*=[\s]*([0-9a-z\.]*)[\s]*-->\s*$/;
    match = rxx.exec(str);
    if (match != null) {
